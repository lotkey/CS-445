...
std::string AST_node::to_string() const
{
    ...
    case Type::Node::Expression:
        ...
        case Type::Expression::Decrement:
            return "Decrement";
        case Type::Expression::Id:
            return "Id";
        case Type::Expression::Increment:
            return "Increment";
        case Type::Expression::Operator:
            return "Operator";
        case Type::Expression::Or:
            return "Or";
        case Type::Expression::Range:
            return "Range";
        case Type::Expression::RelationalOperator:
            return "RelationalOperator";
        case Type::Expression::Simple:
            return "Simple";
        case Type::Expression::Sum:
            return "Sum";
        case Type::Expression::UnaryOperator:
